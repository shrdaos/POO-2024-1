...
public class ProyectoGobernacionTest {
    ...
    public void ParquesMunicipio() {
        ...
        var pijao1 = new ParqueInfantil("P1", "D1", Municipio.PIJAO);
        var cordoba1 = new ParqueInfantil("P2", "D2", Municipio.CORDOBA);
        var buenavista1 = new ParqueInfantil("P3", "D3", Municipio.BUENAVISTA);
        var pijao2 = new ParqueInfantil("P4", "D4", Municipio.PIJAO);
        var cordoba2 = new ParqueInfantil("P5", "D5", Municipio.CORDOBA);
        var buenavista2 = new ParqueInfantil("P6", "D6", Municipio.BUENAVISTA);
        ...
        Collection<ParqueInfantil> listaEsperada = List.of(pijao1, pijao2);
    ...
    public void OrdenPorValor() {
        ...
        var zona = new ZonaParque("Zona 1", new Cuadrado(15), Material.ASFALTO);

        pijao1.addZona(zona);
        cordoba1.addZona(zona);
        buenavista1.addZona(zona);

        pijao2.addZona(zona);
        cordoba2.addZona(zona);
        buenavista2.addZona(zona);
        ...
        Collection<ParqueInfantil> listaEsperada = List.of(cordoba1, cordoba2, buenavista1, buenavista2, pijao1, pijao2);
